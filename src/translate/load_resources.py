...
load_ada_pontic_material_map=ohd_label2uri.load_ada_procedure_material_map(filepath=label2uri_path, procedure_type_name='pontic')
load_ada_extraction_material_map=ohd_label2uri.load_ada_procedure_material_map(filepath=label2uri_path, procedure_type_name='surgic_tooth_extraction')
load_ada_oral_evaluation_material_map=ohd_label2uri.load_ada_procedure_material_map(filepath=label2uri_path, procedure_type_name='oral_evaluation')
load_ada_dental_implant_abutments_material_map=ohd_label2uri.load_ada_procedure_material_map(filepath=label2uri_path, procedure_type_name='dental_implant_abutments')
load_ada_dental_implant_crown_material_map=ohd_label2uri.load_ada_procedure_material_map(filepath=label2uri_path, procedure_type_name='dental_implant_crown')
load_ada_dental_implant_body_material_map=ohd_label2uri.load_ada_procedure_material_map(filepath=label2uri_path, procedure_type_name='dental_implant_body')
load_ada_root_removal_material_map=ohd_label2uri.load_ada_procedure_material_map(filepath=label2uri_path, procedure_type_name='root_removal')
load_ada_removable_denture_material_map=ohd_label2uri.load_ada_procedure_material_map(filepath=label2uri_path, procedure_type_name='removable_denture')
load_ada_pulp_capping_material_map=ohd_label2uri.load_ada_procedure_material_map(filepath=label2uri_path, procedure_type_name='pulp_capping')
load_ada_pulp_regeneration_material_map=ohd_label2uri.load_ada_procedure_material_map(filepath=label2uri_path, procedure_type_name='pulp_regeneration')
load_ada_debridement_material_map=ohd_label2uri.load_ada_procedure_material_map(filepath=label2uri_path, procedure_type_name='debridement')